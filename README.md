...
|Project|Description|Info|
|-|-|-|
|[agents](https://github.com/MaxWolf-01/agents)|Claude Code plugin for persistent agent memory, task tracking, and session continuity.|[![Claude](https://img.shields.io/badge/Claude-D97757?logo=claude&logoColor=fff)](#)|
